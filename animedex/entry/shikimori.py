...
register_subcommand(shikimori_group, "character-search", _api.character_search, help="Search top-level characters.")
register_subcommand(shikimori_group, "character", _api.character, help="Top-level character by Shikimori numeric id.")
register_subcommand(shikimori_group, "publishers", _api.publishers, help="Manga publisher taxonomy.")
register_subcommand(shikimori_group, "publisher", _api.publisher, help="Publisher by Shikimori numeric id.")
...
register_subcommand(shikimori_group, "studio", _api.studio, help="Studio by Shikimori numeric id.")
