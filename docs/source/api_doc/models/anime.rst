...
.. autoclass:: Anime
    :members: id,title,score,episodes,studios,streaming,description,genres,tags,status,format,season,season_year,aired_from,aired_to,duration_minutes,cover_image_url,banner_image_url,trailer_url,source_material,country_of_origin,is_adult,age_rating,popularity,favourites,trending,next_airing_episode,ids,source
